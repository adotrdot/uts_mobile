...
class _LoginPageState extends State<LoginPage> {
  ...
  var namauser;
  _buatInput(namacontroller, String hint, bool isPassword) {
        ...
        body: Container(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  _buatInput(_usernameController, 'Masukkan Username', false),
                  _buatInput(_passwordController, 'Masukkan Password', true),
                  ElevatedButton(
